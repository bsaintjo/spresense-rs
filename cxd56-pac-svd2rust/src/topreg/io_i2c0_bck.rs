///Register `IO_I2C0_BCK` reader
pub type R = crate::R<IoI2c0BckSpec>;
///Register `IO_I2C0_BCK` writer
pub type W = crate::W<IoI2c0BckSpec>;
...
impl W {
    ///Bit 0 - Input enable: 0=disabled, 1=enabled
    #[inline(always)]
    pub fn enzi(&mut self) -> EnziW<'_, IoI2c0BckSpec> {
        EnziW::new(self, 0)
    }
    ///Bit 8 - Pullup: 0=pullup enabled, 1=normal (off)
    #[inline(always)]
    pub fn pun(&mut self) -> PunW<'_, IoI2c0BckSpec> {
        PunW::new(self, 8)
    }
    ///Bit 16 - Pulldown: 0=pulldown enabled, 1=normal (off)
    #[inline(always)]
    pub fn pdn(&mut self) -> PdnW<'_, IoI2c0BckSpec> {
        PdnW::new(self, 16)
    }
    ///Bit 24 - Output current: 0=4mA(max 64MHz), 1=2mA(max 32MHz)
    #[inline(always)]
    pub fn lowemi(&mut self) -> LowemiW<'_, IoI2c0BckSpec> {
        LowemiW::new(self, 24)
    }
}
/**IOCELL control for I2C0_BCK pad

You can [`read`](crate::Reg::read) this register and get [`io_i2c0_bck::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`io_i2c0_bck::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct IoI2c0BckSpec;
impl crate::RegisterSpec for IoI2c0BckSpec {
    type Ux = u32;
}
///`read()` method returns [`io_i2c0_bck::R`](R) reader structure
impl crate::Readable for IoI2c0BckSpec {}
///`write(|w| ..)` method takes [`io_i2c0_bck::W`](W) writer structure
impl crate::Writable for IoI2c0BckSpec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets IO_I2C0_BCK to value 0x0101_0100
impl crate::Resettable for IoI2c0BckSpec {
